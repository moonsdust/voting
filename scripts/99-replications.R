...
#### Load data ####
rid_data <- read_csv("data/raw_data/rid_data.csv", show_col_types = FALSE)
county_data <- read_csv("data/raw_data/county_data.csv", show_col_types = FALSE)
