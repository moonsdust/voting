...
```{r}
#| label: fig-a3
#| fig-cap: General Impediments of Texas voters who filed RIDs in 2016 by Race (Figure A3 from paper)
#| echo: false # Code will run and its output will show but the code itself will not be included in the doc
#| warning: false # Warnings are not included 
#| message: false # Messages are not included 
# Graph
...
```{r}
#| label: tbl-a3
#| tbl-cap: General Impediments of Texas voters who filed RIDs in 2016 by Race (Figure A3 from paper)
#| echo: false # Code will run and its output will show but the code itself will not be included in the doc
#| warning: false # Warnings are not included 
#| message: false # Messages are not included 
